                                ...
                                <tr>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.11111111111111">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.125">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.14285714285714">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.16666666666667">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.2">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.25">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.33333333333333">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="0.5">
                                    </td>
                                    <td>
                                        =
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="2">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="3">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="4">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="5">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="6">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="7">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="8">
                                    </td>
                                    <td>
                                        <input type="radio" name="optionsRadios{{$index+1}}" id="optionsRadios1"
                                            ng-model="item.bobot" ng-change="setNilai(item)" value="9">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
