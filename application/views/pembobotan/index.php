    ...
    <div class="col-md-12">
        ...
        <div ng-if="view=='matriks'">
            <div class="box">
                    ...
                    <button class="btn btn-info pull-right" ng-click="next()">Next</button>
                    <button ng-if="view=='matriks' && !bobot" class="btn btn-primary" ng-click="simpananalisa()">Simpan</button>
                </div>
        </div>
        <div ng-show="view=='hasil'">
            ...
            <div class="col-md-12">
                ...
                <button ng-if="btnSimpan && bobot" class="btn btn-primary" ng-click="simpananalia()">Simpan</button>
            </div>
        </div>
    </div>
</div>